function [data_out] = eval_ArbitrationRL3_readout(param_in, data_in, mode)
% Load the parameter files from the optimization folder, and then evaluate the model.
data_type = mode.data_type;


%% create MAP
task_2019=mode.task_2019;
task_2022=mode.task_2022;
...
pop_id=1; % fixed
Sum_NegLogLik=0.0; Sum_NegLogLik_ucs=0.0;
Sum_NegLogLik_each_simul_eachSC=zeros(1,5);
Num_occur_eachSC=zeros(1,5); % # of each mode (min SPE max SPE min RPE max RPE random)
% arbitrator
...
myArbitrator.opt_m2=mode.opt_m2;
myArbitrator.USE_FWDSARSA_ONLY=mode.USE_FWDSARSA_ONLY;
...
for ind_dev=[1:1:length(pt_devaluation)]
    ...
    for ll=1:1:tot_num_sbj % each subject
        ...
        n_tmp=0;
        if(mode.out==99 || mode.out==2) % in regressor generation mode, do simulation only once
            mode.total_simul=1;
        end
...
%                 disp(sprintf('- generating regressor for SBJ%02d/%02d...',ll,tot_num_sbj));
                ...
                data_in{1,ll}.regressor{1,24}.name='RPE_ABS';     data_in{1,ll}.regressor{1,24}.value=[]; % Absolut Estimator of RPE
                data_in{1,ll}.regressor{1,24}.Tag={'row1: session';'row2: block';'row3: trial in block';'row4: trial_s in trial';'row5: goal';'row6: active_model';'row7: RPE_ABS'};                
                data_in{1,ll}.regressor{1,25}.name='invF1_corrected';     data_in{1,ll}.regressor{1,25}.value=[]; % invF1_corrected
                data_in{1,ll}.regressor{1,25}.Tag={'row1: session';'row2: block';'row3: trial in block';'row4: trial_s in trial';'row5: goal';'row6: active_model';'row7: invF1_corrected'};                
                data_in{1,ll}.regressor{1,26}.name='invF2_corrected';     data_in{1,ll}.regressor{1,26}.value=[]; % invF2_corrected
                data_in{1,ll}.regressor{1,26}.Tag={'row1: session';'row2: block';'row3: trial in block';'row4: trial_s in trial';'row5: goal';'row6: active_model';'row7: invF2_corrected'};                
                data_in{1,ll}.regressor{1,27}.name='invF1_normalized';     data_in{1,ll}.regressor{1,27}.value=[]; % invF1_normalized
                data_in{1,ll}.regressor{1,27}.Tag={'row1: session';'row2: block';'row3: trial in block';'row4: trial_s in trial';'row5: goal';'row6: active_model';'row7: invF1_normalized'};                
                data_in{1,ll}.regressor{1,28}.name='dInvFanoCorrected12';     data_in{1,ll}.regressor{1,28}.value=[]; % dInvFanoCorrected12
                data_in{1,ll}.regressor{1,28}.Tag={'row1: session';'row2: block';'row3: trial in block';'row4: trial_s in trial';'row5: goal';'row6: active_model';'row7: dInvFanoCorrected12'};                
                data_in{1,ll}.regressor{1,29}.name='QMB_full';     data_in{1,ll}.regressor{1,29}.value=[]; % QMB_full
                data_in{1,ll}.regressor{1,29}.Tag={'row1: session';'row2: block';'row3: trial in block';'row4: trial_s in trial';'row5: goal';'row6: active_model';'row7~16: QMB_full (s1a1, s1a2 ... s5a2)'};                
                data_in{1,ll}.regressor{1,30}.name='QMF_full';     data_in{1,ll}.regressor{1,30}.value=[]; % QMF_full
                data_in{1,ll}.regressor{1,30}.Tag={'row1: session';'row2: block';'row3: trial in block';'row4: trial_s in trial';'row5: goal';'row6: active_model';'row7~16: QMF_full (s1a1, s1a2 ... s5a2)'};                
                data_in{1,ll}.regressor{1,31}.name='Qarb_full';     data_in{1,ll}.regressor{1,31}.value=[]; % Qarb_full
                data_in{1,ll}.regressor{1,31}.Tag={'row1: session';'row2: block';'row3: trial in block';'row4: trial_s in trial';'row5: goal';'row6: active_model';'row7~16: Qarb_full (s1a1, s1a2 ... s5a2)'};                
                data_in{1,ll}.regressor{1,32}.name='T_full';     data_in{1,ll}.regressor{1,32}.value=[]; % T_full
                data_in{1,ll}.regressor{1,32}.Tag={'row1: session';'row2: block';'row3: trial in block';'row4: trial_s in trial';'row5: goal';'row6: active_model';'row7~46: T_full (5*2*4, s1a1s2, s1a1s2 ... s5a2s9)'};                
                data_in{1,ll}.regressor{1,33}.name='P_action';     data_in{1,ll}.regressor{1,33}.value=[]; % P(s,a)
                data_in{1,ll}.regressor{1,33}.Tag={'row1: session';'row2: block';'row3: trial in block';'row4: trial_s in trial';'row5: goal';'row6: active_model';'row7~8: p(a1), p(a2)'};                
                que_window=1;
            ...
            Sum_NegLogLik_each_simul_eachMode=zeros(1,5);
            Num_occur_eachMode=zeros(1,5); % # of each mode (G,G',H,H')
            OBS=[];
            ...
            if(mode.experience_sbj_events(1)~=-1)
                ...
                while ((i<num_max_trial0)&&(cond))
                    i=i+1;
                    map0.trial=i;
                    % read a mode from data, the type of goal (fle = -1,
                    % spe = # of goal condition)
                    mode_data=map0.data(map0.trial,18);
                    if task_2019
                        mode_data=map0.data(map0.trial,19);
                    end
                    ...
                    if mode.task_2019
                        ...
                        block_rewards=data_in{1,ll}.HIST_map_state_info_pre{1,1}.map(i).map_sbj(1).reward_save(6:N_state-1);
                        if rem(i,35)==0
                            prob_seed_mat=[0.9,0.1];
                        end          
                        prob_seed_mat = data_in{1,ll}.HIST_map_state_info_pre{1,1}.map(i).map_sbj(1).action(1).prob(1,2:3);
                    else
                        if(block_condition==1) % G
                            % set T_prob
                            prob_seed_mat=[0.9 0.1];
                        elseif(block_condition==2) % G'
                            % set T_prob
                            prob_seed_mat=[0.5 0.5];
                        elseif(block_condition==3) % H
                            % set T_prob
                            prob_seed_mat=[0.5 0.5];
                        elseif(block_condition==4) % H'
                            % set T_prob
                            prob_seed_mat=[0.9 0.1];
                        end
                    end
                    if(data_in{1,ll}.map_type==1)
                        ...
                        if task_2019
                            map0.reward_save(6:N_state-1)=block_rewards;
                        end
                    end
                    if(data_in{1,ll}.map_type==2)
                        % T_prob encoding to the current map
                    ...
                    if(mode_data_prev~=mode_data) % if there is any visual cue change, then goal mode
                        backward_flag=1; % after backward update, should set it to 0.                        
                    end
                    
                    if(backward_flag==1 || task_2022) % if the agent detects context change or 2022 task
                        % (1) revaluation
                        ...
                        map0.reward=zeros(N_state,1);    map0.reward(mode_data_mat)=map0.reward_save(mode_data_mat);
                        if task_2022; map0.reward = data_in{1,ll}.HIST_map_state_info_pre{1,1}.map(i).map_sbj(1).reward; end
                        % (2) backward update of the fwd model
                        if(mode.USE_BWDupdate_of_FWDmodel==1)
                            state_fwd=Model_RL(state_fwd, param_fwd, map0, 'bwd_update');
                        end
                    else
                        % preserve reward values
                        map0.reward=map0.reward_save;
                    end
                    ...
                    while (~state_fwd.JobComplete)
                        % decision
                        if(mode.experience_sbj_events(1)==1)
                            state_fwd=Model_RL(state_fwd, param_fwd0, map0, 'decision_behavior_data_save', 'task_2019', mode.task_2019);
                        else
                            state_fwd=Model_RL(state_fwd, param_fwd0, map0, 'decision_random');
                        end
                        % state transition
                        [state_fwd map0]=StateSpace_v1(state_fwd,map0,opt_state_space,'task_2019', mode.task_2019);  % map&state index ++
                        % 1. fwd model update
...
%                 if(mode.experience_sbj_events(1)==0)                    num_max_trial0=num_max_trial0/2;                end
                while ((i<num_max_trial0)&&(cond))
                    ...
                    if(data_in{1,ll}.map_type==1)
                        ...
                        if task_2019
                            map0_s.reward_save(6:N_state-1)=block_rewards;
                        end
                    end
                    if(data_in{1,ll}.map_type==2)
                        % T_prob encoding to the current map
                    ...
                    while (~state_sarsa.JobComplete)
                        ...
                        if(mode.experience_sbj_events(1)==1)
                            state_sarsa=Model_RL(state_sarsa, param_sarsa0, map0_s, 'decision_behavior_data_save', 'task_2019', mode.task_2019);
                        else
                            state_sarsa=Model_RL(state_sarsa, param_sarsa0, map0_s, 'decision_random');
                        end
                        % 1. sarsa state update (get reward and next state) : (r,s')
                        [state_sarsa map0_s]=StateSpace_v1(state_sarsa,map0_s,opt_state_space,'task_2019', mode.task_2019); % map&state index ++
            ...
            for ind_sess=1:1:num_max_session
                ...
                while ((i<num_max_trial)&&(cond))
                    ...
                    if mode.task_2019
                        ...
                        block_rewards=data_in{1,ll}.HIST_map_state_info{1,ind_sess}.map(i).map_sbj(1).reward_save(6:N_state-1);
                        if rem(i,35)==0
                            prob_seed_mat=[0.9,0.1];
                        end
                        prob_seed_mat = data_in{1,ll}.HIST_map_state_info{1,ind_sess}.map(i).map_sbj(1).action(1).prob(1,2:3);
                    else
                        if(block_condition==1) % G
                            % set T_prob
                            prob_seed_mat=[0.9 0.1];
                    ...
                    if(data_in{1,ll}.map_type==1)
                        ...
                        map.action(1,1).prob(2,[7 9])=prob_seed_mat;
                        map.action(1,1).prob(3,[8 9])=prob_seed_mat;
                        map.action(1,1).prob(4,[7 9])=prob_seed_mat;
                        map.action(1,1).prob(5,[6 9])=prob_seed_mat;
                        map.action(1,2).prob(1,[4 5])=prob_seed_mat;
                        map.action(1,2).prob(2,[8 7])=prob_seed_mat;
                        map.action(1,2).prob(3,[7 9])=prob_seed_mat;
                        map.action(1,2).prob(4,[6 7])=prob_seed_mat;
                        map.action(1,2).prob(5,[7 9])=prob_seed_mat;
                        if task_2019
                            map.reward_save(6:N_state-1)=block_rewards;
                        end
                    end
                    if(data_in{1,ll}.map_type==2)
                        % T_prob encoding to the current map
                    ...
                    if task_2019
                        mode_data=map.data(map.trial,19);
                    end
                    ...
                    while (((myArbitrator_top.ind_active_model==1)&&(~map.JobComplete))||((myArbitrator_top.ind_active_model==2)&&(~map.JobComplete)))
                        ...
                        if(myArbitrator_top.backward_flag==1 || task_2022) % if the agent detects context change
                            % (1) revaluation
                            if(mode_data==-1) % reevaluation for habitual mode
                                mode_data_mat=[6 7 8 9];
                            else % reevaluation for goal mode
                            ...
                            if task_2022; map.reward = data_in{1,ll}.HIST_map_state_info{1,ind_sess}.map(i).map_sbj(1).reward; end
                            % (2) backward update of the fwd model
                            if(mode.USE_BWDupdate_of_FWDmodel==1)
...
%                                 vec_reg=[an_s; an_i; an_ib; an_j; an_g; myArbitrator_top.ind_active_model; myArbitrator_top.m2_inv_Fano;]; % session; block; trial; trial_s; goal; active_model; invFano of m2 (3x1);
                                ...
                                if task_2019
                                     action_chosen=map.data(map.trial,7+map.index);
                                end
...
%                                 vec_reg=[an_s; an_i; an_ib; an_j; an_g; myArbitrator_top.ind_active_model; myArbitrator_top.Q(1,action_chosen)]; % session; block; trial; trial_s; goal; active_model; choice prob of m1                                
                                ...
                                % will be added at the end of this code
                                % regressor24- abs RPE estimator
                                an_j=1;
                                vec_reg=[an_s; an_i; an_ib; an_j; an_g; myArbitrator_top.ind_active_model; 0]; % session; block; trial; trial_s; goal; active_model; abs_RPE (1x1);
                                data_in{1,ll}.regressor{1,24}.value=[data_in{1,ll}.regressor{1,24}.value vec_reg];
                                % regressor25- corrected_invF1
                                % will be added at the end of this code
                                % regressor26- corrected_invF2
                                % will be added at the end of this code
                                % regressor27- normalized_invF1
                                an_j=1; % trial_s in trial (2 or 3)
                                vec_reg=[an_s; an_i; an_ib; an_j; an_g; myArbitrator_top.ind_active_model; 0]; % session; block; trial; trial_s; goal; active_model; abs of RPE estimator;
                                data_in{1,ll}.regressor{1,27}.value=[data_in{1,ll}.regressor{1,27}.value vec_reg];
                                % regressor28- corrected_invF1-corrected_invF2
                                % will be added at the end of this code 
                                % regressor29- QMB_full
                                an_j=1; % trial_s in trial (2 or 3)
                                vec_reg=[an_s; an_i; an_ib; an_j; an_g; myArbitrator_top.ind_active_model; zeros(10,1)]; % session; block; trial; trial_s; goal; active_model; QMBs;
                                data_in{1,ll}.regressor{1,29}.value=[data_in{1,ll}.regressor{1,29}.value vec_reg];
                                % regressor30- QMF_full
                                an_j=1; % trial_s in trial (2 or 3)
                                vec_reg=[an_s; an_i; an_ib; an_j; an_g; myArbitrator_top.ind_active_model; zeros(10,1)]; % session; block; trial; trial_s; goal; active_model; abs of RPE estimator;
                                data_in{1,ll}.regressor{1,30}.value=[data_in{1,ll}.regressor{1,30}.value vec_reg];
                                % regressor31- Qarb_full
                                an_j=1; % trial_s in trial (2 or 3)
                                vec_reg=[an_s; an_i; an_ib; an_j; an_g; myArbitrator_top.ind_active_model; zeros(10,1)]; % session; block; trial; trial_s; goal; active_model; abs of RPE estimator;
                                data_in{1,ll}.regressor{1,31}.value=[data_in{1,ll}.regressor{1,31}.value vec_reg];
                                % regressor32- T_full
                                an_j=1; % trial_s in trial (2 or 3)
                                vec_reg=[an_s; an_i; an_ib; an_j; an_g; myArbitrator_top.ind_active_model; zeros(40,1)]; % session; block; trial; trial_s; goal; active_model; abs of RPE estimator;
                                data_in{1,ll}.regressor{1,32}.value=[data_in{1,ll}.regressor{1,32}.value vec_reg];
                                % regressor33 - P(s,a)
                                an_j=1; % trial_s in trial (2 or 3)
                                vec_reg=[an_s; an_i; an_ib; an_j; an_g; myArbitrator_top.ind_active_model; zeros(2,1)]; % session; block; trial; trial_s; goal; active_model; abs of RPE estimator;
                                data_in{1,ll}.regressor{1,33}.value=[data_in{1,ll}.regressor{1,33}.value vec_reg];
                            end
                        ...
                        if task_2019
                            state_data=map.data(map.trial,4+map.index);
                            action_chosen=map.data(map.trial,7+map.index);
                        end
                        ...
                        myArbitrator_top.Q=...
                            ((myArbitrator_top.m1_prob*state_fwd.Q).^myArbitrator_top.p+...
                            (myArbitrator_top.m2_prob*state_sarsa.Q).^myArbitrator_top.p).^(1/myArbitrator_top.p);
%                          disp([myArbitrator_top.m1_prob, myArbitrator_top.m2_prob, myArbitrator_top.p]) % disp(state_fwd.Q(state_data,:)) % disp(state_sarsa.Q(state_data,:))
                        ...
                        if prob_seed_mat(1)<0.7
                           Sum_NegLogLik_ucs= Sum_NegLogLik_ucs-eval_num/(mode.total_simul);
                        end
                        
                        
                        Sum_NegLogLik_each_simul=Sum_NegLogLik_each_simul-eval_num/(1*1);
                        % block condition of each trial: 1:G(low T uncertainty), 2:G'(hiqmgh T uncertainty), 3:H(high T uncertainty), 4:H'(low T uncertainty)
                        ...
                        % block condition of each trial: 1:G(low T uncertainty), 2:G'(hiqmgh T uncertainty), 3:H(high T uncertainty), 4:H'(low T uncertainty)
                        if data_type == '2019'
                            block_cond_SC=data_in{1,ll}.HIST_block_condition{1,ind_sess}(3,map.trial);
                            Sum_NegLogLik_each_simul_eachSC(block_cond_SC)=Sum_NegLogLik_each_simul_eachSC(block_cond_SC)-eval_num/(mode.total_simul*tot_num_sbj);
                            Num_occur_eachSC(block_cond_SC)=Num_occur_eachSC(block_cond_SC)+1;
                        end
                        ...
                        if(myArbitrator_top.ind_active_model==1) % fwd
                            ...
                            if(mode.experience_sbj_events(2)==1)
                                state_fwd=Model_RL(state_fwd, param_fwd, map, 'decision_behavior_data_save', 'task_2019', mode.task_2019);
                            else
                            ...
                            [state_fwd map]=StateSpace_v1(state_fwd,map,opt_state_space,'task_2019', mode.task_2019); % map&state index ++
                        ...
                        if(myArbitrator_top.ind_active_model==2) % sarsa
                            % 0. current action selection : (s,a) - using arbitrator's Q-value                            
                            if(mode.experience_sbj_events(2)==1)
                                state_sarsa=Model_RL(state_sarsa, param_sarsa, map, 'decision_behavior_data_save', 'task_2019', mode.task_2019);
                            else
                                state_sarsa=Model_RL(state_sarsa, param_sarsa, map, 'decision_arbitrator', myArbitrator_top, state_fwd);
                            end
                            % 1. sarsa state update (get reward and next state) : (r,s')
                            [state_sarsa map]=StateSpace_v1(state_sarsa,map,opt_state_space,'task_2019', mode.task_2019); % map&state index ++
...
%                         if i == num_max_trial; disp(state_fwd.T(1,[3,5])); end
                        ...
                        if(mode.out==99) % regressors
                            ...
                            an_j=myArbitrator_top.index+1; % trial_s in trial (2 or 3)
                            if(an_j==2)
                                state_data=map.data(map.trial,3+map.index);                                action_chosen=map.data(map.trial,6+map.index);
                                if task_2019
                                    state_data=map.data(map.trial,4+map.index);                                action_chosen=map.data(map.trial,7+map.index);
                                end
                                if(action_chosen==1)    action_unchosen=2;  end
                                if(action_chosen==2)    action_unchosen=1;  end
...
%                                 vec_reg=[an_s; an_i; an_ib; an_j; an_g; myArbitrator_top.ind_active_model; myArbitrator_top.Q(state_data,action_chosen)]; % session; block; trial; trial_s; goal; active_model; x                                
                            ...
                            % regressor24- abs RPE estimator
                            an_j=myArbitrator_top.index+1; % trial_s in trial (2 or 3)
                            vec_reg=[an_s; an_i; an_ib; an_j; an_g; myArbitrator_top.ind_active_model; myArbitrator_top.m2_absPEestimate]; % session; block; trial; trial_s; goal; active_model; abs of RPE estimator;
                            data_in{1,ll}.regressor{1,24}.value=[data_in{1,ll}.regressor{1,24}.value vec_reg];
                            % regressor25- corrected_invF1
                            % will be added at the end of this code    
                            % regressor26- corrected_invF2
                            ...
                            % regressor27- normalized_invF1
                            an_j=myArbitrator_top.index+1; % trial_s in trial (2 or 3)
                            vec_reg=[an_s; an_i; an_ib; an_j; an_g; myArbitrator_top.ind_active_model; invF1normalized]; % session; block; trial; trial_s; goal; active_model; abs of RPE estimator;
                            data_in{1,ll}.regressor{1,27}.value=[data_in{1,ll}.regressor{1,27}.value vec_reg];
                            % regressor28- corrected_invF1-corrected_invF2
                            % will be added at the end of this code    
                            % regressor29- QMB_full
                            ...
                            for state_indx = 1:5
                                for action_indx = 1:2
                                    tmp_QMB(state_indx*2-2+action_indx,1) = state_fwd.Q(state_indx,action_indx);
                                end
                            end
                            vec_reg=[an_s; an_i; an_ib; an_j; an_g; myArbitrator_top.ind_active_model; tmp_QMB]; % session; block; trial; trial_s; goal; active_model; QMBs;
                            data_in{1,ll}.regressor{1,29}.value=[data_in{1,ll}.regressor{1,29}.value vec_reg];
                            % regressor30- QMF_full
                            an_j=myArbitrator_top.index+1; % trial_s in trial (2 or 3)
                            tmp_QMF = zeros(10,1);
                            for state_indx = 1:5
                                for action_indx = 1:2
                                    tmp_QMF(state_indx*2-2+action_indx,1) = state_sarsa.Q(state_indx,action_indx);
                                end
                            end
                            vec_reg=[an_s; an_i; an_ib; an_j; an_g; myArbitrator_top.ind_active_model; tmp_QMF]; % session; block; trial; trial_s; goal; active_model; abs of RPE estimator;
                            data_in{1,ll}.regressor{1,30}.value=[data_in{1,ll}.regressor{1,30}.value vec_reg];
                            % regressor31- Qarb_full
                            an_j=myArbitrator_top.index+1; % trial_s in trial (2 or 3)
                            tmp_Qarb = zeros(10,1);
                            for state_indx = 1:5
                                for action_indx = 1:2
                                    tmp_Qarb(state_indx*2-2+action_indx,1) = myArbitrator_top.Q(state_indx,action_indx);
                                end
                            end
                            vec_reg=[an_s; an_i; an_ib; an_j; an_g; myArbitrator_top.ind_active_model; tmp_Qarb]; % session; block; trial; trial_s; goal; active_model; abs of RPE estimator;
                            data_in{1,ll}.regressor{1,31}.value=[data_in{1,ll}.regressor{1,31}.value vec_reg];
                            % regressor32- T_full
                            an_j=myArbitrator_top.index+1; % trial_s in trial (2 or 3)
                            tmp_T = zeros(40,1);
                            for state_indx = 1:5
                                for action_indx = 1:2
                                    for next_state_indx = 1:4
                                        switch state_indx
                                            case 1
                                                tmp_T(state_indx*8-8+action_indx*4-4+next_state_indx,1) = state_fwd.T(state_indx,action_indx,next_state_indx+1);
                                            otherwise
                                                tmp_T(state_indx*8-8+action_indx*4-4+next_state_indx,1) = state_fwd.T(state_indx,action_indx,next_state_indx+5);
                                        end
                                    end
                                end
                            end
                            vec_reg=[an_s; an_i; an_ib; an_j; an_g; myArbitrator_top.ind_active_model; tmp_T]; % session; block; trial; trial_s; goal; active_model; abs of RPE estimator;
                            data_in{1,ll}.regressor{1,32}.value=[data_in{1,ll}.regressor{1,32}.value vec_reg];
                            % regressor33- P(s,a)
                            an_j=myArbitrator_top.index+1; % trial_s in trial (2 or 3)
                            vec_reg=[an_s; an_i; an_ib; an_j; an_g; myArbitrator_top.ind_active_model; var_exp(1); var_exp(2)]; % session; block; trial; trial_s; goal; active_model; abs of RPE estimator;
                            data_in{1,ll}.regressor{1,33}.value=[data_in{1,ll}.regressor{1,33}.value vec_reg];
                        end
...
%             data_in{1,ll}.regressor{1,20}.value(8,zero_pt_ind)=0.0; % fill up '0' for the trivial state (state#1)
            ...
            % regressor25- corrected_invF1
            data_in{1,ll}.regressor{1,25}.value=data_in{1,ll}.regressor{1,21}.value; % copy the entire structure
            data_in{1,ll}.regressor{1,25}.value(8,:)=invF1_corrected;
            % regressor26- corrected_invF2
            data_in{1,ll}.regressor{1,26}.value=data_in{1,ll}.regressor{1,21}.value; % copy the entire structure
            data_in{1,ll}.regressor{1,26}.value(8,:)=invF2_corrected;
            % regressor28- corrected_invF1-corrected_invF2
            data_in{1,ll}.regressor{1,28}.value=data_in{1,ll}.regressor{1,21}.value; % copy the entire structure
            data_in{1,ll}.regressor{1,28}.value(8,:)=invF1_corrected-invF2_corrected;
        end
    end
...
if(mode.out==2) % Each scenario Neglog
    data_out=[Sum_NegLogLik_each_simul_eachSC; Num_occur_eachSC];
end
if(mode.out==3) % high ucs scenario
    data_out=Sum_NegLogLik_ucs;
end
% function ends
end
