...
job.data_type = '2022'; %'2020'; %'2014','dep','2019', '2022'
only_40 = 0;
%% Inputs
...
switch job.data_type
    case '2014'
       sbj_included=1:24;
        for jj=1:24
            for parameter_indx=1:280%1:280%221:240%1:280
                job.nth=jj*1000+parameter_indx;
                job.name = 'batch_model_arbitration_regressor_gen_v6_sjh';
